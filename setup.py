...
setup(name='tankbuster',
      ...
      package_data={'tankbuster': ['*.py', 'classifier/*.hdf5', 'cnn/*.py', 'engine/*.py']},
      author_email='tuomo.hiippala@iki.fi',
      license='MIT',
      keywords=['osint', 'imaging', 'classifier', 'deep learning', 'convolutional neural nets'],
      download_url='https://github.com/thiippal/tankbuster/tarball/0.2',
